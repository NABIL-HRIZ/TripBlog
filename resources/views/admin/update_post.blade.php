      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <!-- partial -->
         <div class="p-4">
            ...
            <form class="row g-3 mt-4" action="{{url('update',$posts->id)}}" method="POST" enctype="multipart/form-data">
                
                @csrf
                
                <div class="col-12 mt-4 ">
                  <label for="inputTitle" class="form-label">Post Title </label>
                  <input type="text" class="form-control" id="inputTitle" name="title" value='{{$posts->title}}'>
                </div>
                <div class="col-12 mt-4">
                  <label for="inputDescription" class="form-label">Post Description</label>
                  <input type="text" class="form-control" id="inputDescription" name="description" value='{{$posts->description}}'>
                </div>
               
                <div class="mt-4">
                    <h3 style="font-size: 20px">Old Pic </h3>
                    <img src={{"image/".$posts->image}} alt="" style='margin-top:10px'>
                </div>
